...
forloop: 	
    ...
    add.d f14, f14,f16            ; Don't move this line up, that will increase the cycles a lot
                                  ; final sum to be stored in result, one result finished completely
...
;====================== Below For Testing ===============================================
    ;l.d   f18, result($zero)    ;load all the results to the register f18-f26 to check if they are correct.     
